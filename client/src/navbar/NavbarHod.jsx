...
//                   <li><a className="dropdown-item" href="/duty/approve">Pending Requests</a></li>
...
export function NavbarHod() {
  ...
  return (
    <Navbar className="sticky top-0 z-10 mx-auto max-w-screen-xl p-3 lg:rounded-full lg:pl-6 mt-3">
